  ...
  actions: {
    ...
    async list({ commit }, payload) {
      try {
        ...
        let response = await $http.get("/settings/languages", {
          params: payload
        });
    ...
    async create({ commit }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $http.post("/settings/languages", payload);
        let responsePayload = response.data;
    ...
    async view({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.get(`/settings/languages/${id}`);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async update({ commit }, { id, payload }) {
      commit("SET_LOADING");
      try {
        let response = await $http.put(`/settings/languages/${id}`, payload);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async archive({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/settings/languages/${id}/archive`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async unarchive({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/settings/languages/${id}/unarchive`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async delete({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.delete(`/settings/languages/${id}`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
