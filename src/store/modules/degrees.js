  ...
  actions: {
    ...
    async list({ commit }, payload) {
      try {
        ...
        let response = await $http.get("/settings/degrees", {
          params: payload
        });
    ...
    async create({ commit }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $http.post("/settings/degrees", payload);
        let responsePayload = response.data;
    ...
    async view({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.get(`/settings/degrees/${id}`);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async update({ commit }, { id, payload }) {
      commit("SET_LOADING");
      try {
        let response = await $http.put(`/settings/degrees/${id}`, payload);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async archive({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/settings/degrees/${id}/archive`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async unarchive({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/settings/degrees/${id}/unarchive`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async delete({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.delete(`/settings/degrees/${id}`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
