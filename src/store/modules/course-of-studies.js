/* src/store/modules/course-of-studies.js */
  ...
  actions: {
    ...
    async list({ commit }, payload) {
      try {
        ...
        let response = await $http.get("/settings/course-of-studies", {
          params: payload
        });
    ...
    async create({ commit }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $http.post("/settings/course-of-studies", payload);
        let responsePayload = response.data;
    ...
    async view({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.get(`/settings/course-of-studies/${id}`);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async archive({ commit }, id) {
      ...
      try {
        let response = await $http.patch(
          `/settings/course-of-studies/${id}/archive`
        );
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async unarchive({ commit }, id) {
      ...
      try {
        let response = await $http.patch(
          `/settings/course-of-studies/${id}/unarchive`
        );
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async delete({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.delete(`/settings/course-of-studies/${id}`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
