/* src/store/modules/job-invitations.js */
  ...
  actions: {
    ...
    async list({ commit }, payload) {
      try {
        ...
        let response = await $http.get("/job-invitations", {
          params: payload
        });
    ...
    async create({ commit }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $http.post("/job-invitations", payload);
        let responsePayload = response.data;
    ...
    async check({ commit }, payload) {
      commit("SET_LOADING");
      try {
        let response = await $http.post("/job-invitations/check", payload);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async view({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.get(`/job-invitations/${id}`);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async update({ commit }, { id, payload }) {
      commit("SET_LOADING");
      try {
        let response = await $http.put(`/job-invitations/${id}`, payload);
        let responsePayload = response.data;
        commit("SET_DATA", responsePayload);
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
    ...
    async archive({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/job-invitations/${id}/archive`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async unarchive({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/job-invitations/${id}/unarchive`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async accept({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/job-invitations/${id}/accept`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async reject({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.patch(`/job-invitations/${id}/reject`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    async delete({ commit }, id) {
      commit("SET_LOADING");
      try {
        let response = await $http.delete(`/job-invitations/${id}`);
        let responsePayload = response.data;
        commit("SET_SUCCESS", responsePayload.message);
      } catch (error) {
        if (error && error.data) {
    ...
    //   commit("SET_LOADING");
    //   try {
    //     let response = await $http.post(`/job-invitations/delete-multiple`, payload);
    //     let responsePayload = response.data;
    //     commit("SET_SUCCESS", responsePayload.message);
    //   } catch (error) {
    //     if (error && error.data) {
